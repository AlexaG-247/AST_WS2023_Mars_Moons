...
defineProps({
  ...
  moonsStart: {type: Number, default: 0},
  moonsEnd: {type: Number, default: 0},
})
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1252 1252">
    <g id="Overlap-Moon">
        <path :d="'M625 625'+CalculateCoordinates(500, moonsStart, 125)+'A500 500 0 '+ CalculatePathParameter(moonsStart, moonsEnd) +''+CalculateCoordinates(500, moonsEnd, 125)+'Z'" fill="#fffbeb" opacity=".15" />
    </g>
